...
angular.module('gaugesScreen', [])
  ...
  .controller('GaugesScreenController', function ($scope, $element, $window) {
    ...
    $scope.onSVGLoaded = function () {
      ...
      speedoDisplay.gears_root = hu('#gears_layer', svg);
      speedoDisplay.gears.P = hu('#gearP', speedoDisplay.gears_root);
      speedoDisplay.gears.R = hu('#gearR', speedoDisplay.gears_root);
      speedoDisplay.gears.N = hu('#gearN', speedoDisplay.gears_root);
      speedoDisplay.gears.D = hu('#gearD', speedoDisplay.gears_root);
